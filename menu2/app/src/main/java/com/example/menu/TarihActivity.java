        ...
        imgtarih2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(context,
                        new DatePickerDialog.OnDateSetListener() {
                            @Override
                            public void onDateSet(DatePicker view, int yıl, int ay, int gun) {
                                ay += 1;


                                edt2.setText(gun + "/" + ay + "/" + yıl);



                                SimpleDateFormat tarihbir = new SimpleDateFormat("dd/MM/yyyy");
                                SimpleDateFormat tarihiki = new SimpleDateFormat("dd/MM/yyyy");
