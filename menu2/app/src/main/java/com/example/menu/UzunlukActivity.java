...
public class UzunlukActivity extends AppCompatActivity {
    ...
    String islem="";
    TextView display;
    private String[] uzunluk={"Milimetre","Santimetre","Metre","Kilometre"};
    private String[] uzunluk0={"Milimetre","Santimetre","Metre","Kilometre"};
    private Spinner spinnerUzunluk;
    private Spinner spinnerUzunluk0;
    private ArrayAdapter<String> dataAdapterForUzunluk;
    private ArrayAdapter<String> dataAdapterForUzunluk0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerUzunluk = (Spinner) findViewById(R.id.spnuzun);
        spinnerUzunluk0 = (Spinner) findViewById(R.id.spnuzun0);
        dataAdapterForUzunluk = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, uzunluk);
        dataAdapterForUzunluk0 = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item,uzunluk0);
        dataAdapterForUzunluk.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        dataAdapterForUzunluk0.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerUzunluk.setAdapter(dataAdapterForUzunluk);
        spinnerUzunluk0.setAdapter(dataAdapterForUzunluk0);
        spinnerUzunluk.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {

            @Override
            public void onItemSelected(AdapterView<?> parent, View view,
                                       int position, long id) {
                if(parent.getSelectedItem().toString().equals(uzunluk[0]))
                    dataAdapterForUzunluk = new ArrayAdapter<String>(UzunlukActivity.this, android.R.layout.simple_spinner_item,uzunluk);
                dataAdapterForUzunluk.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinnerUzunluk0.setAdapter(dataAdapterForUzunluk);
            }
        ...
        spinnerUzunluk0.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {

            @Override
            public void onItemSelected(AdapterView<?> parent, View view,
                                       int position, long id) {
                Toast.makeText(getBaseContext(), ""+spinnerUzunluk.getSelectedItem().toString()+"n"+parent.getSelectedItem().toString(), Toast.LENGTH_SHORT).show();
            }
